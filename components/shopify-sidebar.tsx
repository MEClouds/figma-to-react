...
export function ShopifySidebar({ className }: SidebarProps) {
  const [activeItem, setActiveItem] = React.useState("Collections")
  const [openAccordion, setOpenAccordion] = React.useState<string | undefined>("products")
          ...
          <nav className="space-y-1 px-2">
            ...
            >
              ...
              <AccordionItem value="products" className="border-none">
                ...
                <AccordionContent>
                  <div className="pl-11 space-y-1">
                    {["Collections", "Inventory", "Purchase orders", "Transfers", "Gift cards"].map((item) => (
                      <button
                        key={item}
                        className={cn(
